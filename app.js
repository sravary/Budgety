...
var budgetController = (function() {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            if (index !== -1) { // -1 means the index is not in the array
                data.allItems[type].splice(index, 1); // this is the array of our object
            }
        },
        ...
        calculateBudget: function() {
            ...
            if (data.totals.inc > 0) {
                ...
                data.percentage = -1; // -1 makes it nonexistant
            }
        },
...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        num = Math.abs(num); // abs simply removes the sign of the number
        num = num.toFixed(2); // this puts exactly (2) decimal numbers on the num that are rounded

        numSplit = num.split('.');
        int = numSplit[0]
        if (int.length > 3) {
            int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3);
            // based on the parameter, it starts at index 0 and reads 1 element
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            // inc-1, we need to seperate them
